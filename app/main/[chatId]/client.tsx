  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="w-full h-[70vh] flex justify-center items-center">
        <div className="relative sm:w-[300px] sm:h-[400px] md:w-[600px] md:h-[400px] lg:w-[800px] lg:h-[600px] bg-background rounded-md shadow-xl">
          <ScrollArea className="h-[90%] px-6 py-12">
          ...
          >
            ...
            <div className="flex items-center p-3 pt-0">
              ...
              {currentFile && (
                <FileCard file={currentFile} handleRemove={handleFileRemove} />
              )}
